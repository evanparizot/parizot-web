...
import { Directive, Output, ElementRef, EventEmitter, AfterViewInit, OnDestroy, OnInit, Input, NgZone, Inject, PLATFORM_ID } from "@angular/core";
...
//https://github.com/TradeMe/ng-defer-load/blob/master/src/defer-load.directive.ts
@Directive({
  selector: '[deferLoad]'
})
